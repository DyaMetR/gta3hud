...
cursor:Add('&', 21, BIGTEXT_HEIGHT)
cursor:Add('\'', 8, BIGTEXT_HEIGHT)
cursor:Bulk({'(', ')'}, 18, BIGTEXT_HEIGHT)
cursor:Add(',', 10, BIGTEXT_HEIGHT)
cursor:Add('-', 11, BIGTEXT_HEIGHT)
cursor:Add('.', 9, BIGTEXT_HEIGHT)
cursor:Bulk({'/', '0', '1', '2', '3'}, 19, BIGTEXT_HEIGHT)
cursor:Add('4', 20, BIGTEXT_HEIGHT)
cursor:Skip(9)
cursor:Bulk({'5', '6', '7', '8', '9'}, 19, BIGTEXT_HEIGHT)
cursor:Add(':', 9, BIGTEXT_HEIGHT)
cursor:Bulk({'?', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h'}, 19, BIGTEXT_HEIGHT)
cursor:Add('i', 9, BIGTEXT_HEIGHT)
cursor:Bulk({'j', 'k'}, 19, BIGTEXT_HEIGHT)
cursor:Add('l', 15, BIGTEXT_HEIGHT)
cursor:Add('m', 29, BIGTEXT_HEIGHT)
cursor:Bulk({'n', 'o', 'p', 'q', 'r', 's'}, 19, BIGTEXT_HEIGHT)
cursor:Add('t', 21, BIGTEXT_HEIGHT)
cursor:Skip(11)
