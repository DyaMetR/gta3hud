...
local HOOK = GTA3HUD.hookname .. '_auxpow'
...
-- [[ Hide main HUD ]] --
hook.Add('AuxPowerHUDPaint', HOOK, function()
...
-- [[ Hide flashlight HUD ]] --
hook.Add('EP2FlashlightHUDPaint', HOOK, function()
  if GTA3HUD.Enabled() then return true end
end)

-- [[ Replace auxiliary power value ]] --
hook.Add('GTA3HUD_GetSuitPower', HOOK, function()
